...
const sections = [
  {
    focus: "Focus op Rust & Ontspanning",
    slug: "gezichtsbehandelingen-basis",
    fallbackTitle: "Basis gezichtsbehandelingen",
  },
  {
    focus: "Focus op huidverjonging",
    slug: "gezichtsbehandelingen-anti-aging",
    fallbackTitle: "Anti-aging gezichtsbehandelingen",
  },
  {
    focus: "Focus op gezondheid en elasticiteit",
    slug: "gezichtsbehandelingen-huid-verbeterende",
    fallbackTitle: "Huidverbeterende gezichtsbehandelingen",
  },
  {
    focus: "Focus op een specifieke huidaandoening / uitgebreide ontspanning",
    slug: "gezichtsbehandelingen-luxe",
    fallbackTitle: "Luxe gezichtsbehandelingen",
  },
  {
    focus: "Focus op groei, herstel & vernieuwing van de huidcellen",
    slug: "gezichtsbehandelingen-microneedling-derma-pen",
    fallbackTitle: "Microneedling / 1Need",
  },
  {
    focus: "Focus op ontspannen en verminderen van oneffenheden van de huid",
    slug: "gezichtsbehandelingen-peeling",
    fallbackTitle: "Peeling gezichtsbehandelingen",
  },
] as const;
      ...
      <main>
        ...
        <section className="pt-32 pb-20 bg-primary relative overflow-hidden">
          <div className="absolute inset-0 opacity-15">
            <img
              src={getCloudinaryImageUrl("/Blue Diamonds Foto's/IMG_5530.jpg")}
              alt=""
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-3xl">
              ...
              <h1 className="text-display text-cream mt-4 mb-6">
                Gezichtsbehandelingen soorten
              </h1>
              <div className="w-16 h-0.5 bg-accent mb-6" />
              <p className="text-lead-dark">
                Kies eerst het soort gezichtsbehandeling. Op de volgende pagina vind je alle
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {sections.map((s) => {
                ...
                const intro = p?.intro ?? "Ontdek onze professionele gezichtsbehandelingen voor een stralende en gezonde huid.";
